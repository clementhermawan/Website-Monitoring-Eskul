...
// Ambil daftar kegiatan berdasarkan ekstrakurikuler yang diikuti
$queryKegiatan = "SELECT nama, deskripsi, tanggal FROM kegiatan WHERE eskul_id = $eskul_id ORDER BY tanggal DESC";
...
<head>
    ...
    <title>Kegiatan | Monitoring Eskul</title>
...
<div class="content">
    ...
    <div class="container mt-4">
        <h2 class="text-center">Daftar Kegiatan - <?php echo $eskul['nama']; ?></h2>
        <div class="row mt-3">
            <?php while ($kegiatan = mysqli_fetch_assoc($resultKegiatan)) { ?>
                <div class="col-md-4 mb-4">
                    <div class="card p-3">
                        ...
                        <small class="text-muted">Tanggal: <?php echo date('d M Y', strtotime($kegiatan['tanggal'])); ?></small>
                    </div>
                </div>
            <?php } ?>
        </div>
