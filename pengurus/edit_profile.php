...
<div class="sidebar">
    ...
    <a href="kelola_kegiatan.php"><i class="fas fa-calendar-alt"></i> Kegiatan</a>
    <a href="kelola_program.php"><i class="fas fa-tasks"></i> Program</a>
    <a href="kelola_prestasi.php"><i class="fas fa-trophy"></i> Prestasi</a>
</div>
