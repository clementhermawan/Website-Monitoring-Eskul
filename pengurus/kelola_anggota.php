...
$queryAnggota = "SELECT * FROM users WHERE eskul_id = $eskul_id AND role = 'anggota' ORDER BY nama ASC";
...
<head>
    ...
    <style>
        ...
        .sidebar { width: 250px; height: 100vh; position: fixed; background: #243b55; color: white; padding-top: 20px; }
        .sidebar a { display: block; color: white; padding: 15px; text-decoration: none; transition: 0.3s; }
        .sidebar a:hover { background: #1b2a41; }
        .content { margin-left: 250px; padding: 20px; }
        .navbar { background: #243b55; }
        .navbar .nav-link { color: white !important; }
        .profile-img { width: 40px; height: 40px; object-fit: cover; border-radius: 50%; border: 2px solid white; }
